...
const Navbar = () => {
  return (
    <div className='w-screen absolute flex flex-row items-center mt-8 pl-8 pr-8 md:pr-0 md:pl-12 md:h-24 md:mt-0 lg:mt-8'>
      ...
      <div className='h-[1px] w-1/3 md:hidden lg:flex bg-white opacity-25 m-4'></div>

      <div className='hidden md:flex justify-center min-w-[550px] lg:min-w-[830px] h-24 items-center bg-navbar-links backdrop-blur-2xl'>
        <div className='flex flex-row justify-center text-white uppercase font-barlow-condensed gap-16 max-w-[356px] text-sm lg:text-base '>
