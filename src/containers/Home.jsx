...
const Home = () => {
  return (
    <div className='w-screen h-max md:h-screen bg-home-mobile md:bg-home-tablet lg:bg-home-desktop bg-no-repeat bg-cover bg-center flex flex-col'>
      <Navbar />
      <div className='h-screen flex flex-col lg:flex-row lg:items-center lg:mr-[10rem] lg:mt-[5rem] 2xl:mr-[20rem]'>
        <div className='flex flex-col items-center lg:items-start m-auto w-[330px] md:w-[450px] mt-12 md:mt-[4rem] 2xl:gap-4 '>
        ...
        <div className='flex justify-center mb-auto lg:mt-[6rem] 2xl:mt-[6rem]'>
